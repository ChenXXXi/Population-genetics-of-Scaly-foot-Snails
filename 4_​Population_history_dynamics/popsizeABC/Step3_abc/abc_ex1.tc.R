...
infile_params="maf01_simul_data/tc.params"
infile_stat="maf01_simul_data/tc.stat"
n=40 # haploid sample size
mac=4 # minor allele count
source("estim/load_simu.R")

# loads observed samples
infile_obs="~/Data/ydj_cx/new.snpEff/125.sample.onnare_popsizeABC/res_TC/example_vcf_TC_n40_mac4_macld4.stat"
...
# plot
pdf('maf01_simul_data/tc.pdf',height=4,width=4)
