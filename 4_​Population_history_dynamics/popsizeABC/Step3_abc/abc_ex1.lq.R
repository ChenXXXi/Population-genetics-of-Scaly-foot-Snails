...
infile_params="maf01_simul_data/lq.params"
infile_stat="maf01_simul_data/lq.stat"
n=48 # haploid sample size
mac=4 # minor allele count
source("estim/load_simu.R")

# loads observed samples
infile_obs="~/Data/ydj_cx/new.snpEff/125.sample.onnare_popsizeABC/res_LQ/example_vcf_LQ_n48_mac4_macld4.stat"
...
# plot
pdf('maf01_simul_data/lq.pdf',height=4,width=4)
