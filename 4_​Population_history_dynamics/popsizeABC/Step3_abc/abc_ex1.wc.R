...
infile_params="maf01_simul_data/wc.params"
infile_stat="maf01_simul_data/wc.stat"
n=22 # haploid sample size
mac=2 # minor allele count
source("estim/load_simu.R")

# loads observed samples
infile_obs="~/Data/ydj_cx/new.snpEff/125.sample.onnare_popsizeABC/res_WC/example_vcf_WC_n22_mac2_macld2.stat"
...
# plot
pdf('maf01_simul_data/wc.pdf',height=4,width=4)
