...
infile_params="maf01_simul_data/krso.params"
infile_stat="maf01_simul_data/krso.stat"
n=108 # haploid sample size
mac=10 # minor allele count
source("estim/load_simu.R")

# loads observed samples
infile_obs="~/Data/ydj_cx/new.snpEff/125.sample.onnare_popsizeABC/res_kr.so/example_vcf_kr_so_n108_mac10_macld10.stat"
...
# plot
pdf('maf01_simul_data/krso.pdf',height=4,width=4)
...
#plot(abc_res,param=log10_pop(params)[,-1],file='res_WC/ex1_Jersey_mac6_macld6_detailed',subsample=20)
